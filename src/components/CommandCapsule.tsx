...
import { Send, Image as ImageIcon, Settings, ChevronDown, ChevronUp, HardDrive, Info, Key, Check, X, Loader2 } from 'lucide-react';
...
export function CommandCapsule({
  ...
  return (
    <div className="capsule-blur" style={{
      ...
      width: '90%',
      maxWidtAPI Key Icon */}
         <div className="hover-menu-trigger" ref={keyMenuRef} onMouseEnter={() => setShowKeyMenu(true)} onMouseLeave={() => !keyMenuRef.current?.contains(document.activeElement) && setShowKeyMenu(false)}>
            <button 
                className="btn-clean" 
                style={{ 
            ...
            {showKeyMenu && (
              <div className="hover-menu-content" style={{ bottom: '130%', top: 'auto', left: '50%', transform: 'translateX(-50%)', width: '280px', padding: '1rem', background: 'var(--bg-card)', border: '1px solid var(--border-color)', borderRadius: '16px' }}>
                 {apiKey ? (
      ...
      <div style={{ flex: 1, paddingLeft: '1rem' }}>
         <input
           ...
           value={pro
             ...
             <div className="hover-menu-content" style={{ width: '220px', bottom: '130%', top: 'auto', left: '50%', transform: 'translateX(-50%)' }}>
                {!isDriveConnected ? (
                     <div style={{ textAlign: 'center' }}>
